<div
    class="kanban-cel @if(!($r['draggable'] ?? true) || !($status['draggable'] ?? true)) disable-draggable bg-gray-200 dark:bg-gray-800 border-gray-300 dark:border-gray-900 @else bg-white dark:bg-gray-600 border-gray-200 dark:border-gray-700 hover:shadow-lg hover:cursor-move @endif w-full p-3 rounded-lg border flex flex-col gap-2"
