(() => {
  ...
  // packages/heloufir/filament-kanban/resources/js/index.js
    ...
    [].forEach.call(elements, (el) => {
      const sortable = sortable_esm_default.create(el, {
        ...
        onEnd: function(evt) {
          ...
          if (previousList.dataset.status !== targetList.dataset.status || oldIndex2 !== newIndex2) {
