...
class EnumStatusesDemo extends Kanban
{
    ...
    protected static ?string $slug = 'demo/enum-statuses-demo';

    protected static ?string $title = 'Enum Statuses';
    ...
    {
        $this->setStatuses(KanbanService::getStatusesFromEnums());
        $this->setRecords(KanbanService::getRecordsBasedOnEnumStatuses());
    ...
    protected function getActions(): array
    {
        return array_merge([
            Action::make('source')
                ...
                ->url('https://github.com/heloufir/filament-kanban-demo/blob/main/EnumStatusesDemo.php')
        ], Parent::getActions());
    }
