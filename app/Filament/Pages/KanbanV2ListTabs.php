...
class KanbanV2ListTabs extends KanbanBoard
{
    protected static ?string $navigationIcon = 'heroicon-o-list-bullet';

    protected static ?string $slug = 'v2/list-with-tabs';

    protected static ?string $navigationGroup = 'Version 2';

    protected static ?string $title = 'Kanban List with Tabs';
    ...
    protected bool $showStatusesAsTabs = true;
    ...
    protected function getHeaderActions(): array
    {
        return [
            Action::make('source')
                ...
                ->url('https://github.com/heloufir/filament-kanban-demo/blob/main/KanbanV2ListTabs.php', true),
            Action::make('docs')
                ->label('Documentation')
                ->color('gray')
                ->outlined()
