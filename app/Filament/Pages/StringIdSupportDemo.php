...
class StringIdSupportDemo extends Kanban
{
    ...
    protected static ?string $slug = 'demo/string-id-support';

    protected static ?string $title = 'String ID Support';
    ...
    {
        $this->setStatuses(KanbanService::getStatusesWithUuid());
        $this->setRecords(KanbanService::getRecordsWithUuid());
        $this->setResources(KanbanService::getResourcesWithUuid());
    }
